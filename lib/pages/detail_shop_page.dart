...
class DetailShopPage extends StatelessWidget {
  ...
  launchWa(BuildContext context, String number) async {
    ...
    if (yes ?? false) {
      final link = WhatsAppUnilink(
        phoneNumber: number,
        // phoneNumber: '6282281038087',
        text: 'Halo, saya ingin order laundry, apakah bisa',
      );
                    ...
                    children: [
                      ...
                      !shop.pickup && !shop.delivery
                          ...
                          : Padding(
                              ...
                              child: Row(
                                children: [
                                  if (shop.pickup) chilOrder('Pickup'),
                                  if (shop.delivery) DView.width(8),
                                  if (shop.delivery) chilOrder('Delivery'),
                                ],
                              ),
                            ),
                    ],
  ...
  Container chilOrder(String name) {
    return Container(
      decoration: BoxDecoration(
